...
export default function ProgressBar(props){
    ...
    return  desactived ? <Desactivated_progress /> : <Activated_progress progress={progress}>{text_children}</Activated_progress>;
}
...
const Activated_progress = function (props){
    ...
    return (
            <View style={styles.viewProgress}>
                ...
                <View style={[styles.actualProgress, {width: `${progress*100}%`, color:"red"}]} />
